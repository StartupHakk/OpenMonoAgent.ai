...
public static class BuiltInAgents
{
    ...
    public static readonly AgentDefinition Explore = new()
    {
        ...
        AllowedTools = ["FileRead", "Glob", "Grep", "ListDirectory", "WebSearch", "WebFetch", "ToolSearch", "decide_evaluate", "decide_rank", "decide_verify", "decide_gate_action", "decide_next_step", "specialist", "mcp__*"],
        MaxTurns = 100,
        SystemPrompt = """
    ...
    public static readonly AgentDefinition Plan = new()
    {
        ...
        AllowedTools = ["FileRead", "Glob", "Grep", "ListDirectory", "TodoWrite", "WebSearch", "WebFetch", "ToolSearch", "decide_evaluate", "decide_rank", "decide_verify", "decide_gate_action", "decide_next_step", "specialist", "mcp__*"],
        MaxTurns = 100,
        SystemPrompt = """
    ...
    public static readonly AgentDefinition Verify = new()
    {
        ...
        AllowedTools = ["FileRead", "Glob", "Grep", "ListDirectory", "Bash", "Roslyn", "Lsp", "decide_evaluate", "decide_rank", "decide_verify", "decide_gate_action", "decide_next_step", "specialist", "mcp__*"],
        MaxTurns = 150,
        SystemPrompt = """
